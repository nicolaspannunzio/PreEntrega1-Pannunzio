...
const inicioDeSesion = () =>{
    ...
    if (nombreyapellido.length < 3 || nombreyapellido.length > 20 || 
        !nombreyapellido.match(soloLetras)) {
      alert("El nombre y apellido deben tener entre 3 y 20 caracteres. Utiliza letras solamente.");
    };
